...
def main(robotIP):
    ...
    h=0.175#0.13 #meters --height of the plane
    P0=[0,0,h]
    theta_c=result[4]
    ...
    # print "NEW w_z:"+ str(w_z)
        # Compute the rotation to point towards the landmark.
    cameraToLandmarkRotationTransform = almath.Transform_from3DRotation(1, w_y, w_z)
    print "camera to the detection:"
   ...
   # wz=wz-robotPosition_theta0
    ...
    # transformList = almath.vectorFloat(transform)
    # robotToCamera = almath.Transform(transformList)
    # print "this is robot to cammera"
    # print robotToCamera
    # w_prime= robotToCamera*cameraToLandmarkRotationTransform
    ...
    # Compute the translation to reach the landmark.
    # cameraToLandmarkTranslationTransform = almath.Transform(0.14, 0.01,-0.19)# -(robotToCamera.r3_c4+X[2]))
    # print cameraToLandmarkTranslationTransform
    # Combine all transformations to get the landmark position in NAO space.
    # robotToLandmark = robotToCamera * cameraToLandmarkTranslationTransform
    # print robotToLandmark
    # x,y,z=robotToLandmark.r1_c4,robotToLandmark.r2_c4,robotToLandmark.r3_c4
